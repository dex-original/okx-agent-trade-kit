...
# Contributing to OKX Agent Trade Kit
...
git clone https://github.com/dex-original/okx-agent-trade-kit.git
cd okx-trade-mcp
...
Open a [GitHub Discussion](https://github.com/dex-original/okx-agent-trade-kit/discussions) or file an issue with the `question` label.
